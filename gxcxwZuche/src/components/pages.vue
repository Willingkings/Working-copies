<template>
  <ul class="mo-paging">
    ...
    <!-- prev -->
    <li :class="['paging-item', 'paging-item--prev', {'paging-item--disabled' : index === 1}]" @click="prev"><i class="el-icon-arrow-left"></i></li>
    ...
    <!-- next -->
    <li :class="['paging-item', 'paging-item--next', {'paging-item--disabled' : index === pages}]" @click="next"><i class="el-icon-arrow-right"></i></li>
    <!-- last -->
