// pages/specialLine/ festival/festival.js
Page({
  ...
  onLoad: function (options) {
    ...
    getApp().func.comHttp('/vl/cusbus/app/services/firstPageRecommendAll', {
      ...
      if (res.success == true) {
        that.setData({ festivalListData: res.data })                                // 节日列表数据
      } else {
        console.log("获取节日列表数据接口错误")
      }
    })
  },
  festivalApply: function (e) {
