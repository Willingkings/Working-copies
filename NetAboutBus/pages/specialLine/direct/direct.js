// pages/specialLine/direct/direct.js
Page({
  ...
  onLoad: function (options) {
    ...
    getApp().func.comHttp('/vl/cusbus/app/services/firstPageRecommendAll', {
      ...
      if (res.success == true) {
        that.setData({ directListData: res.data })                                // 直通车列表数据
      } else {
        console.log("获取直达专线列表数据接口错误")
      }
    })
  },
  // 用户点击列表跳转详情
  nonstopApply: function(e) {
