...
var DES3 = {
    ...
    encrypt:function(key,input){
      ...
      // return btoa(des(genKey.key, input, 1, 0, des3iv, 1)); // 小程序无法使用btoa原生的64编码
    },
    //3DES加密，ECB/PKCS5Padding
    encryptCbc: function (key, input) {
      var genKey = genkey(key, 0, 24);
      return des(genKey.key, input, 1, 0, '/ECB/PKCS5Padding', 1);
    },
